...
CREATE TABLE pedido_test (
    id SERIAL PRIMARY KEY,
    cliente_test INT REFERENCES cliente_test(id),
...
INSERT INTO pedido_test (cliente_test, itens) VALUES
...
SELECT * FROM cliente_test INNER JOIN pedido_test ON cliente_test.id = pedido_test.cliente_test
